...
export default function HeroSection() {
  return (
    <div className="font-sans">
      <section className="relative overflow-hidden min-h-[45vh] flex items-center justify-between px-6 py-8 bg-white">
        ...
        <div className="z-10 grid grid-cols-1 md:grid-cols-2 gap-2 w-full items-center">
          {/* Left side content */}
          <div className="max-w-xl">
            <h1 className="font-bold text-3xl md:text-4xl mb-4 text-[#2463EB] leading-tight font-sans text-left">
            ...
            <p className="text-lg md:text-xl text-gray-700 mb-6 font-sans text-left">
