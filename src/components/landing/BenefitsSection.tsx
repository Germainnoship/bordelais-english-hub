...
const benefits = [
  ...
  },
  {
    ...
    text: "Préparation et passage Officiel (TOEIC & autres), CPF accepté.",
  },
];
  ...
  return (
    <section className="py-16 bg-white">
      <div className="container max-w-5xl mx-auto flex flex-col gap-10">
        <h2 className="text-3xl font-bold text-blue-800 mb-8 text-center font-playfair">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {benefits.map((b) => (
            <div
              key={b.title}
              className="bg-blue-50 rounded-xl shadow flex flex-col items-center p-8 hover:shadow-lg transition animate-fade-in"
            >
